...
parrafo2.textContent = "Experimenta lo mejor del deporte";
...
// const contenedor = document.querySelector("body > main > section:nth-child(1) > div > div:nth-child(4)");


const contenedor = document.querySelector(".modulo .contenedor-cards");

// contenedor.appendChild(contenedorCard)


const elReferencia = document.querySelector("body > main > section:nth-child(1) > div > div:nth-child(5)");
